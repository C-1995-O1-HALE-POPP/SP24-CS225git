...
Graph PremadeGraphs::createChinaMap(bool isWeighted)
{
    ...
    string labels[] = {"Beijing", "Shanghai", "Guangzhou", "Shengzhen", "Hangzhou",
                       "Nanjing", "Chongqing","Wuhan",     "Changsha" , "Zhengzhou",
                       "Tianjin", "Chengdu", "Kunming",   "Xi'an",   "Shenyang"};
    ...
    g.insertEdge(vertices[0], vertices[14]);
    g.insertEdge(vertices[0], vertices[13]);
    g.insertEdge(vertices[1], vertices[2]);
    g.insertEdge(vertices[1], vertices[5]);
    g.insertEdge(vertices[0], vertices[10]);
    g.insertEdge(vertices[2], vertices[3]);
    g.insertEdge(vertices[2], vertices[4]);
    g.insertEdge(vertices[4], vertices[5]);
    g.insertEdge(vertices[2], vertices[8]);
    ...
    g.insertEdge(vertices[7], vertices[9]);
    g.insertEdge(vertices[9], vertices[14]);
    g.insertEdge(vertices[11], vertices[13]);
    g.insertEdge(vertices[12], vertices[6]);

    if (isWeighted) {
    g.setEdgeWeight(vertices[0], vertices[1],1065);
    g.setEdgeWeight(vertices[0], vertices[9],630);
    g.setEdgeWeight(vertices[0], vertices[14],632);
    g.setEdgeWeight(vertices[0], vertices[13],910);
    g.setEdgeWeight(vertices[1], vertices[2],1260);
    g.setEdgeWeight(vertices[1], vertices[5],300);
    g.setEdgeWeight(vertices[0], vertices[10],147);
    g.setEdgeWeight(vertices[2], vertices[3],73);
    g.setEdgeWeight(vertices[2], vertices[4],1260);
    g.setEdgeWeight(vertices[4], vertices[5],233);
    g.setEdgeWeight(vertices[2], vertices[8],569);
    g.setEdgeWeight(vertices[6], vertices[7],755);
    g.setEdgeWeight(vertices[6], vertices[8],686);
    g.setEdgeWeight(vertices[6], vertices[11],262);
    g.setEdgeWeight(vertices[7], vertices[8],290);
    g.setEdgeWeight(vertices[7], vertices[9],469);
    g.setEdgeWeight(vertices[9], vertices[14],436);
    g.setEdgeWeight(vertices[11], vertices[13],615);
    g.setEdgeWeight(vertices[12], vertices[6],634);
    }
    return g;
}