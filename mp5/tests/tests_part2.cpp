...
TEST_CASE("Creates a basic MosaicCanvas (gridtest)", "[weight=5][part=2]") {
  ...
  PNG sourcePNG;
  sourcePNG.readFromFile("/home/cometp/cs225sp24/mp5/tests/gridtest.png");////////////////////////////////////////////////////////////////
  ...
  PNG expected;  expected.readFromFile("/home/cometp/cs225sp24/mp5/tests/gridtest-expected.png");////////////////////////////////
